...
class GenericPipeline extends Pipeline {
    ...
    void packagingGeneric(PackagingStageArguments arguments) {
        ...
        arguments.stage = { String stageName ->
            ...
            def returnText2 = this.github.postComment(prNumber,"escape single quote \\\'SINGLEQUOTE\\\'\r")
            def returnText3 = this.github.postComment(prNumber,"escape double quote \\\"DOUBLEQUOTE\\\"\r")
            def returnText4 = this.github.postComment(prNumber,"escape backslash \\\\BLACKSLASH\\\\\r")
            def returnText5 = this.github.postComment(prNumber,"escape tab TABSTART\\\tTABEND\\\t\r")
