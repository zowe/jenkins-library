...
class DockerPipelineMultibranchPipelineTest extends IntegrationTest {
    ...
    // branch to run test
    static final String TEST_JENKINSFILE = 'Jenkinsfile.docker'
    // github tag prefix
    static final String TEST_GITHUB_TAG_PREFIX = 'docker'
    // github api instance
    ...
    void testBConsoleLog() {
        ...
        [
            ...
            'Init github configurations with default ...',
            // build stage
            'Executing stage Build: Dockerfile',
            'Building Docker image from ./Dockerfile ...',
            '+ docker build -t',
            // custom stage
            'Executing stage CustomStage',
            // publish stage
    ...
    void testCRelease() {
        ...
        def currentVersion = githubApi.getVersionFromDockerfile(TEST_BRANCH)
        ...
        def newVersion = githubApi.getVersionFromDockerfile(TEST_BRANCH)
        ...
        String expectedTag = "${TEST_GITHUB_TAG_PREFIX}-v${currentVersion['major']}.${currentVersion['minor']}.${currentVersion['patch']}"
