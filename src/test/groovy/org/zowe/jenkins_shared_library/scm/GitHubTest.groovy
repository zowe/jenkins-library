...
"""
    ...
    @Test
    void testGetCorrectUserPermissionPullRequest() {
        assertThat('Build console log', buildLog, containsString('[GITHUB_TEST] getting correct user permission from pull request successfully'))
    }

    @Test
    void testPostCommentPullRequest() {
        assertThat('Build console log', buildLog, containsString('[GITHUB_TEST] posting a comment on pull request successfully'))
    }

    @Test
    void testUpdateCommentPullRequest() {
        assertThat('Build console log', buildLog, containsString('[GITHUB_TEST] updating a comment on pull request successfully'))
    }
